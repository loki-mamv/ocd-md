# ocd.md — Build Complete ✅

**Domain:** ocd.md  
**Topic:** OCD symptoms, ERP therapy, treatment options  
...
1. **GitHub Repository**
   ```bash
   gh repo create loki-mamv/ocd-md --public
   gh api repos/loki-mamv/ocd-md/collaborators/mike32snake -X PUT -f permission=admin
   ```
...
3. **Configure DNS**
   ...
   - Point ocd.md to loki-mamv.github.io
...
**Output Location:** `/Users/loki/assistant/output/md-sites/remaining/ocd/`  
